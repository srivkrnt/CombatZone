        	...
        	<div className="App">
        		<div className = "left_section">
	              	...
	              	<div className="Form_Fields">
	        			<div className = "Form_Title" >Join as a newbie </div> 
	        			<form>
				       	    <label>NAME</label>
				       	    <input type="text" id="name" placeholder="John Robins" name="name"/>
				       	    <label>EMAIL</label>
				       	    <input type="text" id="email" placeholder="xyz@abc.com" name="email"/>
				       	    <label>PASSWORD</label>
				       	    <input type="password" id="pass" placeholder="********" name="pass1"/>
				       	    <label>CONFIRM PASSWORD</label>
				       	    <input type="password" id="pass2" placeholder="********" name="pass2"/>
